#!/bin/bash
#=============================================================================
# DMD Pipeline - Local Development Runner
#
# Usage:
#   ./run_local.sh [step] [config] [run_dir]
#
# Examples:
#   ./run_local.sh 1 config/example.yaml
#   ./run_local.sh 2 config/example.yaml /path/to/run_dir
#   ./run_local.sh 3 config/example.yaml /path/to/run_dir
#   ./run_local.sh all config/example.yaml
#
#=============================================================================
...
run_step_2() {
    print_header "STEP 2: DMD Fitting"
    if [ -z "$RUN_DIR" ]; then
...
print_header "DMD Pipeline (Local)"
echo "Step: $STEP"
echo "Config: $CONFIG"
